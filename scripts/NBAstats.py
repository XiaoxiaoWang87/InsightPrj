...
class ShotChart:
    def __init__(self,playerid,leagueid='',season='1988-89', seasontype='Regular Season',teamid=0,gameid='',outcome='',location='',
...
class GameLog:
    def __init__(self, playerid, season='1988-89',seasontype='Regular Season', leagueid=''):
...
class Lineups:
    def __init__(self, groupquantity=2, permode='Totals', seasontype='Regular Season', plusminus='Y',
                 paceadjust='Y', rank='Y', season='1988-89', outcome='', location='', month=0,
...
class LeagueLeaders:
    def __init__(self, leagueid='00', permode='Per48',statcat='PTS',season='1988-89',seasontype='Regular Season',scope='S'):
