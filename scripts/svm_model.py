...
def main():
    ...
    bkg_str = 'bkg_100g'
    # Eff = (PTS + REB + AST + STL + BLK) - ( (FGA - FGM) + (FTA - FTM) + TOV )
    #df[sig_str+'_testing']['EFF'] = (df[sig_str+'_testing']['PTS'] + df[sig_str+'_testing']['REB'] + df[sig_str+'_testing']['AST'] + df[sig_str+'_testing']['STL'] + df[sig_str+'_testing']['BLK']) - ((df[sig_str+'_testing']['FGA']-df[sig_str+'_testing']['FGM'])+(df[sig_str+'_testing']['FTA']-df[sig_str+'_testing']['FTM'])+df[sig_str+'_testing']['TOV'])
    #df[bkg_str+'_testing']['EFF'] = (df[bkg_str+'_testing']['PTS'] + df[bkg_str+'_testing']['REB'] + df[bkg_str+'_testing']['AST'] + df[bkg_str+'_testing']['STL'] + df[bkg_str+'_testing']['BLK']) - ((df[bkg_str+'_testing']['FGA']-df[bkg_str+'_testing']['FGM'])+(df[bkg_str+'_testing']['FTA']-df[bkg_str+'_testing']['FTM'])+df[bkg_str+'_testing']['TOV'])
    ...
    #h3_test_sig =  np.histogram(np.array(df[sig_str+'_testing']['REB'].tolist()),bins=20,range=(0,40))
    #h3_test_bkg =  np.histogram(np.array(df[bkg_str+'_testing']['REB'].tolist()),bins=20,range=(0,40))
    ...
    hlist_test_sig = [h1_test_sig, h2_test_sig, h3_test_sig[0]]
    hlist_test_bkg = [h1_test_bkg, h2_test_bkg, h3_test_bkg[0]]
    model_name_list = ['Logistic Regression', 'SVM', 'NBA Player Efficiency']
